...
const Favorites = () => {
  ...
  return (
    <section className={`xs:pl-4 xs:${displayValue} sm2:col-start-2 sm2:col-span-1 row-start-2 sm2:row-span-1 sm:col-start-1 sm:col-span-2 xs:col-span-1 sm:row-span-2 h-full max-h-[333px]`}>
