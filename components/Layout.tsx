...
const Layout = ({ children }: LayoutProps) => {
  return (
    <main className="h-full grid grid-rows-[60px_auto] bg-gradient-to-r from-gray-700 via-gray-900 to-black ">
      ...
      <div className="grid lg:grid-cols-[minmax(500px,_auto)_700px] sm:grid-cols-[480px_auto] md:grid-cols-[480px_auto] md2:grid-cols-[700px_auto] sm2:grid-rows-[55fr_45fr] sm:grid-rows-[65fr_35fr] h-full">
        {children}
      </div>
    </main>
  )
