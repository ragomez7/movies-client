...
const Layout = ({ children }: LayoutProps) => {
  return (
    <main className="sm2:h-full grid grid-rows-[60px_auto] bg-gradient-to-r from-gray-700 via-gray-900 to-black ">
      ...
      <div className="grid lg:grid-cols-[minmax(500px,_auto)_700px] sm:grid-cols-[365px_auto] sm1:grid-cols-[480px_auto] md:grid-cols-[480px_auto] md2:grid-cols-[700px_auto] sm:grid-rows-[5fr_5fr] xs:grid-cols-[minmax(200px,_600px)] xs:grid-rows-[500px_500px] h-full">
        {children}
      </div>
    </main>
  )
